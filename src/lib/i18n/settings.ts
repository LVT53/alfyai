...
const settingsDict = {
	en: {
		...
		"analytics.kindRegenerate": "Regenerate",
		"analytics.kindEditResend": "Edit & resend",
		...
		"admin.campaigns.destination.chatgptImport": "Import from ChatGPT",
	...
	hu: {
		...
		"analytics.kindRegenerate": "Újragenerálás",
		"analytics.kindEditResend": "Szerkesztés és újraküldés",
		...
		"admin.campaigns.destination.chatgptImport": "Importálás ChatGPT-ből",
