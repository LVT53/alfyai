...
// Source: simple-icons siTodoist
// bbox is a perfect 24x24 square (getBBox() via headless Chromium, same
// method as every other glyph here) — opticalSide = sqrt(24*24)/0.8 = 30
// exceeds containSide = 24/0.95, so viewBox is the clean "-3 -3 30 30".
const TODOIST: BrandGlyph = {
	viewBox: "-3 -3 30 30",
