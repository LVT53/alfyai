...
- `stream-completion.ts` owns terminal stream completion: final persistence through `finalize.ts`, generated-file assignment, and the `data-stream-metadata` / `finish` payload shape.
