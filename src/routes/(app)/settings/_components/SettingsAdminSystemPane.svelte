...
const NAMED_KEY_LABEL: Record<string, I18nKey> = {
	...
	MINERU_API_KEY: "admin.mineruApiKey",
	MINERU_DEFAULT_TIER: "admin.mineruDefaultTier",
	MINERU_OCR_MODE: "admin.mineruOcrMode",
	MINERU_JOB_TIMEOUT_MS: "admin.mineruJobTimeoutMs",
	MINERU_POLL_MIN_MS: "admin.mineruPollMinMs",
	MINERU_POLL_MAX_MS: "admin.mineruPollMaxMs",
	MINERU_REQUEST_TIMEOUT_MS: "admin.mineruRequestTimeoutMs",
