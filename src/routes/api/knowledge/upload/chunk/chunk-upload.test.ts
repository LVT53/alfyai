...
vi.mock('$lib/server/services/knowledge/upload-completion', () => ({
	completeStoredKnowledgeUpload: vi.fn(),
}));
...
const mockCompleteStoredKnowledgeUpload = completeStoredKnowledgeUpload as ReturnType<typeof vi.fn>;
